...
const int ESC_PIN     = 9;
const int VOLTAGE_PIN = A3; //formerly A2 on MKR 1010
const int CURRENT_PIN = A2; //formerly A1 on MKR 1010
...
const float ADC_REF  = 3.3; # could possibly be 5V (datasheet unclear) 
